        ...
        const SwitchAccessShortcutAddRound = (props) => {
          return (
        ...
        SwitchAccessShortcutAddRound.displayName = 'SwitchAccessShortcutAddRound';
        
        export default SwitchAccessShortcutAddRound;
