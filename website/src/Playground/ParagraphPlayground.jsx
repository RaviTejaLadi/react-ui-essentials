...
import styles from "./ParagraphPlayground.module.css";
import { Paragraph } from "react-ui-essentials";

const ParagraphPlayground = () => {
  const [content, setContent] = useState("This is a sample paragraph.");
...
>
  ...
  return (
    <div className={styles.playground}>
      <h1 className={styles.title}>Paragraph Playground</h1>
