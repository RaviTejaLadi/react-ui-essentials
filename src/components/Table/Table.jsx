...
const Table = ({ columns, rows, basic, code, CodeColumn, codeColor, codeUnderline, codeStyle }) => {
  return (
    <div className={styles.rue_table_container}>
      <table className={basic ? `${styles.rue_basic_table} ${styles.rue_basic_table_striped}` : `${styles.rue_table}`}>
        <tbody>
          <tr>
