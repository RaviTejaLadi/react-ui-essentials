...
export const Tabs = forwardRef(
  ({ children, controls = false, controlsButtonSize = "sm", controlsButtonVariant = "success", ...rest }, ref) => {
    ...
    return (
      <Box ref={ref} margin="5px" elevation={0} padding="5px" width="98%" height="auto" rounded outlined {...rest}>
